...
description: 月累计联动大屏。用于用户明确要求生成、制作、导出、展示或推送“大屏/可视化大屏/酷炫大屏/柱状图大屏”时，结合各地市装维月累计和正式人员装维月累计生成 HTML/PNG，并可按明确推送词发送企业微信。普通各地市随销月累计报表仍由 area-metrics 处理。
---
...
只负责“月累计联动大屏”：地市月累计 + 正式人员月累计的可视化大屏。
...
如果缺少正式人员月累计 Excel，直接说明缺少文件，不伪造 BI 路径，不用正式人员日清单替代月累计。
