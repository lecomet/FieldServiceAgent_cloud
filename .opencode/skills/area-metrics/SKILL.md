---
name: area-metrics
description: 装维地市汇总查询。用于用户查看全省、山东省、各地市装维随销发展日清单、地市随销统计、各地市随销月清单、生成各地市随销月累计报表或地市汇总，数据粒度是一行一个地市，字段包含装维发展量、全量发展量、占比、积分、人数、人均等。某个地市的装维随销发展日清单应转到 city-metrics 取该地市所有区县。
---
